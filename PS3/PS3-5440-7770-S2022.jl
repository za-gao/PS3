...
md"###### This didn't affect the result from C1, because the rate limiting step v2 is not bounded in the case. However, if use the equation without -1 in the denominator, with all other setups unchanged, the resulting flux analysis is different:
